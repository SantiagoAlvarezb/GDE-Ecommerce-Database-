...
#  URL patterns define the mapping between URLs and the corresponding views or actions within the application
...
urlpatterns = [
    ...
    path(
        "videogames/", login_required(VideogameList_view.as_view()), name="videogames"
    ),
    path("packages/", PackageList_view.as_view(), name="packages"),
    path("dlcs/", DlcList_view.as_view(), name="dlcs"),
    path(
        "videogames/<str:pk>/", VideogameDetail_view.as_view(), name="videogame_detail"
    ),
    ...
    path(
        "videogames/<str:pk>/delete/",
        VideogameDelete_view.as_view(),
        name="videogame_delete",
    ),
    path(
        "packages/<str:pk>/delete/", PackageDelete_view.as_view(), name="package_delete"
    ),
    path("dlcs/<str:pk>/delete/", DlcDelete_view.as_view(), name="dlc_delete"),
    path(
        "videogames/<str:pk>/update/",
        VideogameUpdate_view.as_view(),
        name="videogame_update",
    ),
    path(
        "packages/<str:pk>/update/", PackageUpdate_view.as_view(), name="package_update"
    ),
    ...
    path(
        "delivery/list_orders/<str:pk>/",
        DeliveryDetail_view.as_view(),
        name="detail_order",
    ),
    path(
        "delivery/list_orders/<str:pk>/confirm",
        DeliveryConfirm_view.as_view(),
        name="confirm_order",
    ),
]
