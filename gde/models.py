...
# models that represent various components of an e-commerce application
...
class Videogame(models.Model):
    ...
    rating = models.CharField(
        max_length=20, choices=RATING_CHOICES, default="Rating Pending"
    )
    ...
    category = models.ForeignKey(
        Category, on_delete=models.PROTECT, default=2, editable=False
    )
...
class Dlc(models.Model):
    ...
    administrator = models.ForeignKey(User, on_delete=models.PROTECT)
    category = models.ForeignKey(
        Category, on_delete=models.PROTECT, default=3, editable=False
    )
...
class Package(models.Model):
    ...
    administrator = models.ForeignKey(User, on_delete=models.PROTECT)
    category = models.ForeignKey(
        Category, on_delete=models.PROTECT, default=1, editable=False
    )
