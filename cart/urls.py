...
# Defines URL patterns web application related to a shopping cart functionality
...
urlpatterns = [
    ...
    path(
        "remove_videogame/<str:videogame_name>/",
        remove_videogame,
        name="remove_videogame",
    ),
    ...
    path(
        "decrease_videogame/<str:videogame_name>/",
        decrease_videogame,
        name="decrease_videogame",
    ),
    path("decrease_dlc/<str:dlc_name>/", decrease_dlc, name="decrease_dlc"),
    path(
        "decrease_package/<str:package_name>/",
        decrease_package,
        name="decrease_package",
    ),
    ...
    path(
        "decrease_product/<str:product_name>/", decrease_cart, name="decrease_product"
    ),
